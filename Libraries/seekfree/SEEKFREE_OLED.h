...
//----宏定义OLED引脚----	 
#define  OLED_SCL_PIN	G4
#define  OLED_SDA_PIN	G5
#define  OLED_RST_PIN	F1
#define  OLED_DC_PIN	F0
#define  OLED_CS_PIN	G7
...
void OLED_Print_Num2(uint8 x, uint8 y, int16 num);
